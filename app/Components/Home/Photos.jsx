        ...
        <div className=' flex items-center  justify-between '>
            ...
            <div className='flex items-center sm:gap-7 gap-3 border-l-[1px] border-l-gray-200 pl-2 md:pl-5'>
                ...
                <div onClick={()=>setsearchSettingOpened(!searchSettingOpened)} className='relative cursor-pointer'>
                    ...
                    {
                        searchSettingOpened && <div className='absolute right-0 top-8 z-20 w-52 flex flex-col py-2 text-gray-500 capitalize bg-white shadow-md shadow-gray-500 rounded-md px-2'>
                        {
