                  ...
                  <Link
                    ...
                    className={
                      item.linkUrl === "pixabay radio"
                        ? "flex  items-center capitalize gap-2 hover:underline text-xs text-gray-500 py-1"
                        : "capitalize hover:underline text-sm text-gray-500 py-1"
                    }
                  >
                    {item.linkUrl}
                    {item.linkUrl === "pixabay radio" && (
              ...
              {community.map((item, index) => {
                return (
                  <Link
                    ...
                    key={index}
                    className={
                      "capitalize hover:underline text-xs text-gray-500 py-1"
                    }
                  >
                    {item.linkUrl}
                  </Link>
